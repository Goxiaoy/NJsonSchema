...
namespace NJsonSchema.CodeGeneration.Dart
{
    ...
    public class DartValueGenerator : ValueGeneratorBase
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="DartValueGenerator" /> class.</summary>
        /// <param name="settings">The settings.</param>
        public DartValueGenerator(DartGeneratorSettings settings)
            : base(settings)
        {
            _settings = settings;
        }
