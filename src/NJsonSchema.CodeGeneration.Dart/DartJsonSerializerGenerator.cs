...
namespace NJsonSchema.CodeGeneration.Dart
{
    ...
    public static class DartJsonSerializerGenerator
    {
        ...
        public static string GenerateJsonSerializerParameterCode(DartGeneratorSettings settings, IEnumerable<string> additionalJsonConverters)
        {
